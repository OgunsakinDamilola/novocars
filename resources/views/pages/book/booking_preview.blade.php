@extends('layouts.app')
@section('page-title')  Booking Preview @endsection
            ...
            <div class="panel-body">
                <div class="invoice-masthead">
                    <div class="invoice-text">
                        <h4 class="h4 text-uppercase text-thin mar-no text-primary">Booking Preview</h4>
                    </div>
                    ...
                    <div class="col-sm-6 text-xs-center">
                        <table class="invoice-details">
                            ...
                            <tr>
                                ...
                                <td class="text-right"><span class="badge badge-success">{{$bookingInfo->id}}</span></td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-lg-12 table-responsive">
                        <table class="table table-bordered invoice-summary">
                            ...
                            <tr>
                                ...
                                @endif                                <td class="text-right">&#x20A6;{{number_format($bookingPaymentInfo['driver_outstation_fee'],2)}}</td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                @else
                                    @if($bookingPaymentInfo['duration'] > 1)
                                        ...
                                        <td class="text-center">&#x20A6;{{number_format(($bookingPaymentInfo['daily_rental_rate_amount'] / ($bookingPaymentInfo['duration'] - 1)),2)}}</td>
                                        @else
                                        <td class="text-center">{{$bookingPaymentInfo['duration']}} <small>({{$bookingPaymentInfo['duration']}})</small> day(s)</td>
                ...
                <div class="text-right no-print">
                    ...
                    <form method="post" class="pull-right" action="{{$transactionInfo['action_url']}}">
                        ...
                        <button class="btn btn-primary" type="submit">Pay Now <i class="fa fa-credit-card-alt"></i></button>
                            ...
                            @else
                            <label class="label label-danger"> <i class="fa fa-times"></i> Expired </label>
                       @endif
                    @endif
                </div>
                <hr class="new-section-sm bord-no">
